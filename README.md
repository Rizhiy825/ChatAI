...
Проект использует только легковесные библиотеки (без tensorflow/torch):
...
> ⚡ **Примечание:** Проект не требует установки тяжелых ML-библиотек (tensorflow, torch). Вся обработка происходит через OpenAI API.
